        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tbody>
               <?php 							        
											$query = $db1->query("SELECT * FROM question2");
								        	if($query) {
									        		while($row = $query->fetch_assoc())//将result结果集中查询结果取出一条							        			
									        		{
									        			...
									        			echo "<td>".$row["max"]."</td>";
									        			echo "<td>".$row["min"]."</td>";
									        			echo "<td>".$row["mid"]."</td><td>".$row["ave"]."</td>
														<td>".$row["differ"]."</td><td>".$row["stdv"]."</td><td>".$row["full"]."</td>";
									        			echo ' <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
            ...
            <div class="am-cf">
              <div class="am-fr">
                <ul class="am-pagination">
                  ...
                  <li class="am-active"><a href="table2re.php">1</a></li>
